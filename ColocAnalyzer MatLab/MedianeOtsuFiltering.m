function [ImageFilteredNew, threshold_main, threshold_sec] = MedianeFiltering(Image, main_channel, sec_channel, Boxsize)
%This function applies mediane filtering of two channels separately and
%after Otsu tresholding for each channel
...
% creating a background matrix for each channel
...
%applying Otsu ttresholding

[ImageFilteredNew, threshold_main, threshold_sec] = OtsuFiltering(ImageFiltered,main_channel,sec_channel);
end
